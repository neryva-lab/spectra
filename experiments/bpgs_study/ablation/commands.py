...
from experiments.bpgs_study.common.paths import PROJECT_ROOT, SUBSET_ROOT
...
def build_subset_stage(study_name: str) -> Stage:
    ...
    script = PROJECT_ROOT / "experiments" / "bpgs_study" / "nyuv2_subsets.py"
    return Stage(
...
def _resolve_output_dir(study_name: str, variant: TrainingVariant, seed: int) -> Path:
    from experiments.bpgs_study.common.paths import OUTPUT_ROOT
